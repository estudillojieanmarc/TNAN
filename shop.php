...
<head>
    ...
    <link rel="stylesheet" href="/TNAN/includes/css/fashion.css">
...
<body> 
        ...
        <!-- NAVBAR -->
            <nav class="navbar navbar-expand-lg px-2 sticky-top navbar-dark">
                <div class="container-fluid">
                    <a class="navbar-brand text-white fw-bold" style="font-size:15px" href="#">FASHION TEEN TRENDS</a>
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <a class="nav-link dropdown-toggle text-white fw-bold" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        </a>
                    ...
                    <div class="col-md-2">
                        <div class="sidenav mt-3">
                            <div class="sideHeader">
                                <h4 class="m-2 text-dark"><span style="color:#AD8B73">Fashion</span> <br>Categories</h4>
                            </div>
                            <div class="sideBody">
                            <div id="get_category"><!-- FETCH CATEGORY --></div>
                            </div>
                            <div class="sideFooter">
                                <div class="pt-3 px-2 text-dark" id="clockDisplay"><!-- FETCH CATEGORY --></div>
                                <div class="pt-2 px-1 text-dark" style="font-size:14px;" id="dateDisplay"><!-- FETCH CATEGORY --></div>
                            </div>
                        </div>
                    </div>
                <div class="col-md-10">	
                    <div class="card col-12" style="border-radius:8px;" id="scroll">
                        <div class="card-heading px-4 pt-4"><h4><i class="bi bi-bag-dash-fill"></i> COMFY-AESTHETIC-STYLISH</h4></div>
                            <div class="card-body">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="container-fluid" >
                                <div class="row g-4">
                                    <div class="col-11">
                                        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-shopping-cart px-1"></i>Cart <span class="text-danger">Details</span></h5>
                                    </div>
                                    <div class="col-1">
        ...
        <!-- MANAGE PROFILE  -->
            <div class="modal fade" id="manageProfile" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-11">
                                    <h5 class="modal-title" id="exampleModalLabel"> <i class="far fa-id-card"></i> MANAGE <span class="text-danger">PROFILE</span></h5>
                                </div>
                                <div class="col-1">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-7" style="align-items:center;">
                                            <div class="pt-4 mt-5">
                                                ...
                                                <input class="form-control text-dark" style="border-radius:10px;" type="file" name="updateImage">
                                            </div>
                                        </div>
                                        <div class="col-5">
                                             <img class="img-thumbnail" style="height:140px; width:180px; " src="" id="updateImage">
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-7">
                                            <label class="form-label  px-2">Fullname: <small class="text-secondary">(Ln, Fn Mi)</small></label>
                                            <input type="text" class="form-control text-dark" style="border-radius:20px;" name="updateFname" id="updateFname">
                                        </div>
                                        <div class="col-5">
                                            <label class="form-label  px-2">Contact:</label>
                                            <input type="text" class="form-control text-dark" style="border-radius:20px;" name="updateContact" id="updateContact">
                                        </div>
                                    </div>
                                    <div class="row g-3 mb-3">
                                        <div class="col-12">
                                            <label class="form-label px-2">Address:</label>
                                            <input type="text" class="form-control text-dark" style="border-radius:20px;" name="updateAddress" id="updateAddress">
                                        </div>
                                    </div>
                                    <div class="row g-3 mb-2">
                                        <div class="col-6">
                                            <label class="form-label px-2">Username:</label>
                                            <input type="text" class="form-control text-dark" style="border-radius:20px;" name="updateUsername" id="updateUsername">
                                        </div>
                                        <div class="col-6">
                                            <label class="form-label  px-2">Email:</label>
                                            <input type="text" class="form-control text-dark" style="border-radius:20px;" name="updateEmail" id="updateEmail">
                                        </div>
                                    </div>
                                    <div class="row ">
                                        <div class="col-12">
                                            <label class="form-label  px-2">Password:</label>
                                            <input type="text" class="form-control text-dark text-center" style="border-radius:20px;" placeholder="CONFIDENTIAL" name="updatePassword">
                                        </div>
                                    </div>
                            </div> 
                            </div>
                            <div class="row mb-4">
                                <div class="col-5 ms-auto">
                                    <button type="button" id="updateBtn" name="updateBtn" class="btn btn-primary">Save changes</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <!-- PURCHASE HISTORY -->
            <div class="modal fade" id="purchaseHistoryModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-11">
                                    <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-history px-1"></i> Purchased <span class="text-danger">History</span></h5>
                                </div>
                                <div class="col-1">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row g-4">
                                <div class="col-11">
                                    <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-truck"></i> Pending <span class="text-danger">Order</span></h5>
                                </div>
                                <div class="col-1">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
...
<script src="/TNAN/includes/js/action.js"></script>
</html>
