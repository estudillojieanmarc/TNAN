...
<head>
    ...
    <link rel="stylesheet" href="/TNAN/includes/css/shopss.css">
                    ...
                    <div class="col-md-2">
                        <div class="sidenav">
                            <div class="sideHeader">
                                <div class="col-4 px-4"><h4 class="m-2 text-dark"><span style="color:#AD8B73;">Fashion</span> <br>Categories</h4></div>
                            </div>
                            <div class="sideBody pt-2" id="get_category">
                            </div>
                            <div class="sideFooter px-4 pt-2">
                                <div class="px-2 text-dark" id="clockDisplay"><!-- FETCH CATEGORY --></div>
                                <div class="pt-2 px-1 text-dark text-uppercase" style="font-size:14px; " id="dateDisplay"><!-- FETCH CATEGORY --></div>
                            </div>
                        </div>
                    </div>
                <div class="col-md-10">	
                    <div class="card col-12" style="border-radius:8px;" id="scroll">
                        <div class="card-heading px-4 pt-4">
                            <div class="row">
                                <div class="col-8">
                                    <h4><i class="bi bi-bag-dash-fill"></i> MEET UP • PICK UP • DELIVERY</h4>
                                </div>                                
                            </div>
                        </div>
                            <div class="card-body">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="container-fluid" >
                                <div class="row g-4">
                                    <div class="col-11">
                                        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-shopping-cart px-1"></i>Cart <span style="color:#AD8B73;">Details</span></h5>
                                    </div>
                                    <div class="col-1">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-11">
                                    <h5 class="modal-title" id="exampleModalLabel"> <i class="far fa-id-card"></i> MANAGE <span style="color:#AD8B73;">PROFILE</span></h5>
                                </div>
                                <div class="col-1">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-11">
                                    <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-history px-1"></i> Purchased <span style="color:#AD8B73;">History</span></h5>
                                </div>
                                <div class="col-1">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row g-4">
                                <div class="col-11">
                                    <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-truck"></i> Pending <span style="color:#AD8B73;">Order</span></h5>
                                </div>
                                <div class="col-1">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
