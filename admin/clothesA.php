        ...
        <div style="margin-left:15%">
            <div class="container bg-white pt-5 mt-2">
                ...
                <ul class="nav nav-tabs mb-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-primary " href="http://localhost/TNAN/admin/clothesNA.php">NOT ACTIVE</a>
                    </li>
                </ul>
                <div class="d-flex col-12">
                    <a type="button" class="btn btn-outline-dark mx-1" href="http://localhost/TNAN/admin/clothesA.php"> <i class="fas fa-redo px-1"></i> REFRESH </a>
                    <button type="button" class="btn btn-outline-primary mx-1" data-bs-toggle="modal" data-bs-target="#addDish"> <i class="fas fa-plus px-1"></i> ADD PRODUCT</button>
                </div>
            </div>
        ...
        <div class="modal fade" id="addDish" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-11">
                            <h5 class="modal-title" id="exampleModalLabel" style="font-size:23px;"><i class="fas fa-plus"></i> New <span class="text-danger">Product</span> </h5>
                        </div>
                        <div class="col-1">
                ...
                <div class="row mt-4">
                    <div class="col-5 ms-auto">
                        <button type="button" class="btn btn-primary"  name="foodSubmit" id="foodSubmit">Add Product</button>
                    </div>
                </div>
            </form>
                </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="row g-4 mb-2">
                    ...
                    <div class="col-4">
                        ...
                        <input class="form-control" type="text" value="Active" style="color:green; background:transparent" readonly>
                    </div>
                </div>   
