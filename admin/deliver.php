...
<?php session_start();?>
    ...
    <!-- MAIN CONTENT -->
        <div class="w3-sidebar bg-light w3-bar-block text-dark" style="width:15%;">
            ...
            <a href="/TNAN/admin/foodA.php" class="w3-bar-item w3-button pt-3 sm-py-3 text-center">PRODUCTS</a>
        ...
        <div style="margin-left:15%">
            <div class="container bg-white pt-5 mt-2 ">
                ...
                <ul class="nav nav-tabs mb-4">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/TNAN/admin/deliver.php">&nbsp;&nbsp;TO DELIVER&nbsp;&nbsp;</a>
                        </li>
                        <li class="nav-item">
        ...
        <script>
            $("body").delegate("#page","click",function(){
                ...
                $.ajax({
                    url	:	"/TNAN/admin/fetchdata/getTransaction.php",
                    method	:	"POST",
                    data	:	{getDeliver:1,setPage:1,pageNumber:pn},
                    success	:	function(data){
    ...
    <!-- FUNCTION FOR MARKED A FOOD -->
        <script>
            function marked(id){
                Swal.fire({
                title: 'Are you sure?',
                text: "Do you want to mark this order?",
                icon: 'warning',
    ...
    <!-- END FUNCTION FOR MARKED A FOOD -->
